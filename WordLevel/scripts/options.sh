...
HMM_LOCATION=$HMM_TOPOLOGY_DIR/6state-16pca	#text hmm topology file
HMM_ALL=$HMM_LOCATION

# yes/no depending on whether using specific topologies per token 
SPECIFIC=no

HMM_TOKEN_A=$HMM_TOPOLOGY_DIR/6state-16pca
HMM_TOKEN_B=$HMM_TOPOLOGY_DIR/6state-16pca
HMM_TOKEN_C=$HMM_TOPOLOGY_DIR/6state-16pca
HMM_TOKEN_D=$HMM_TOPOLOGY_DIR/6state-16pca
HMM_TOKEN_E=$HMM_TOPOLOGY_DIR/6state-16pca
HMM_TOKEN_F=$HMM_TOPOLOGY_DIR/6state-16pca
HMM_TOKEN_G=$HMM_TOPOLOGY_DIR/6state-16pca
HMM_TOKEN_H=$HMM_TOPOLOGY_DIR/12state-16pca
HMM_TOKEN_I=$HMM_TOPOLOGY_DIR/12state-16pca
HMM_TOKEN_J=$HMM_TOPOLOGY_DIR/12state-16pca
HMM_TOKEN_K=$HMM_TOPOLOGY_DIR/12state-16pca
HMM_TOKEN_L=$HMM_TOPOLOGY_DIR/12state-16pca
HMM_TOKEN_M=$HMM_TOPOLOGY_DIR/12state-16pca
HMM_TOKEN_N=$HMM_TOPOLOGY_DIR/12state-16pca
HMM_TOKEN_O=$HMM_TOPOLOGY_DIR/12state-16pca
HMM_TOKEN_P=$HMM_TOPOLOGY_DIR/12state-16pca
HMM_TOKEN_Q=$HMM_TOPOLOGY_DIR/12state-16pca
HMM_TOKEN_R=$HMM_TOPOLOGY_DIR/12state-16pca
HMM_TOKEN_S=$HMM_TOPOLOGY_DIR/12state-16pca
HMM_TOKEN_T=$HMM_TOPOLOGY_DIR/12state-16pca
HMM_TOKEN_U=$HMM_TOPOLOGY_DIR/12state-16pca
HMM_TOKEN_V=$HMM_TOPOLOGY_DIR/12state-16pca
HMM_TOKEN_W=$HMM_TOPOLOGY_DIR/12state-16pca
HMM_TOKEN_X=$HMM_TOPOLOGY_DIR/12state-16pca
HMM_TOKEN_Y=$HMM_TOPOLOGY_DIR/12state-16pca
HMM_TOKEN_Z=$HMM_TOPOLOGY_DIR/12state-16pca
...
DICTFILE=${PRJ}/dict/dict_letter2letter # Use tri2letter for triletter config, letter2letter for letter
...
TOKENS=${PRJ}/commands/commands_letter_isolated  #commands_tri_internal commands_letter_isolated letter 
