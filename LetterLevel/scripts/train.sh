...
for n in $(cat ${TOKENS});
  do
    ...
    if [[ ${SPECIFIC} == "yes" ]]; then 
      if [[ $n = "A" ]]; then
  	HMM_LOCATION=$HMM_TOKEN_A
      elif [[ $n = "B" ]]; then
  	HMM_LOCATION=$HMM_TOKEN_B
      elif [[ $n = "C" ]]; then
  	HMM_LOCATION=$HMM_TOKEN_C
      elif [[ $n = "D" ]]; then
  	HMM_LOCATION=$HMM_TOKEN_D
      elif [[ $n = "E" ]]; then
  	HMM_LOCATION=$HMM_TOKEN_E
      elif [[ $n = "F" ]]; then
  	HMM_LOCATION=$HMM_TOKEN_F
      elif [[ $n = "G" ]]; then
  	HMM_LOCATION=$HMM_TOKEN_G
      elif [[ $n = "H" ]]; then
  	HMM_LOCATION=$HMM_TOKEN_H
      elif [[ $n = "I" ]]; then
  	HMM_LOCATION=$HMM_TOKEN_I
      elif [[ $n = "J" ]]; then
  	HMM_LOCATION=$HMM_TOKEN_J
      elif [[ $n = "K" ]]; then
  	HMM_LOCATION=$HMM_TOKEN_K
      elif [[ $n = "L" ]]; then
  	HMM_LOCATION=$HMM_TOKEN_L
      elif [[ $n = "M" ]]; then
  	HMM_LOCATION=$HMM_TOKEN_M
      elif [[ $n = "N" ]]; then
  	HMM_LOCATION=$HMM_TOKEN_N
      elif [[ $n = "O" ]]; then
  	HMM_LOCATION=$HMM_TOKEN_O
      elif [[ $n = "P" ]]; then
  	HMM_LOCATION=$HMM_TOKEN_P
      elif [[ $n = "Q" ]]; then
  	HMM_LOCATION=$HMM_TOKEN_Q
      elif [[ $n = "R" ]]; then
  	HMM_LOCATION=$HMM_TOKEN_R
      elif [[ $n = "S" ]]; then
  	HMM_LOCATION=$HMM_TOKEN_S
      elif [[ $n = "T" ]]; then
  	HMM_LOCATION=$HMM_TOKEN_T
      elif [[ $n = "U" ]]; then
  	HMM_LOCATION=$HMM_TOKEN_U
      elif [[ $n = "V" ]]; then
  	HMM_LOCATION=$HMM_TOKEN_V
      elif [[ $n = "W" ]]; then
  	HMM_LOCATION=$HMM_TOKEN_W
      elif [[ $n = "X" ]]; then
  	HMM_LOCATION=$HMM_TOKEN_X
      elif [[ $n = "Y" ]]; then
  	HMM_LOCATION=$HMM_TOKEN_Y
      elif [[ $n = "Z" ]]; then
  	HMM_LOCATION=$HMM_TOKEN_Z
      else
